            ...
            <div className="flex flex-col-reverse md:flex-row md:justify-between items-center">
                    ...
                    ">
                    {
                        skills.map((skill) => (
                            ...
                            >
                                ...
                                <div className="mt-2 text-sm">{skill.name}</div>
                            </div>
                        ))
                    }
                </div>
                <div className="md:ml-4 flex-col space-y-4">
                    {experiences.map((experience) => (
                        <div key={experience.id} className="flex flex-col bg-base-200 rounded-xl shadow-lg p-4">
                            <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                    ...
                                    >{experience.role} {experience.company}</h1>
